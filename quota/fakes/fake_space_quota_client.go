...
type FakeCFSpaceQuotaClient struct {
	...
	SingleStub        func(context.Context, *client.SpaceQuotaListOptions) (*resource.SpaceQuota, error)
...
func (fake *FakeCFSpaceQuotaClient) Single(arg1 context.Context, arg2 *client.SpaceQuotaListOptions) (*resource.SpaceQuota, error) {
...
func (fake *FakeCFSpaceQuotaClient) SingleCallCount() int {
	fake.singleMutex.RLock()
	defer fake.singleMutex.RUnlock()
	return len(fake.singleArgsForCall)
}

func (fake *FakeCFSpaceQuotaClient) SingleCalls(stub func(context.Context, *client.SpaceQuotaListOptions) (*resource.SpaceQuota, error)) {
	fake.singleMutex.Lock()
	defer fake.singleMutex.Unlock()
	fake.SingleStub = stub
}

func (fake *FakeCFSpaceQuotaClient) SingleArgsForCall(i int) (context.Context, *client.SpaceQuotaListOptions) {
	fake.singleMutex.RLock()
	defer fake.singleMutex.RUnlock()
...
func (fake *FakeCFSpaceQuotaClient) SingleReturns(result1 *resource.SpaceQuota, result2 error) {
	fake.singleMutex.Lock()
	defer fake.singleMutex.Unlock()
	fake.SingleStub = nil
...
func (fake *FakeCFSpaceQuotaClient) SingleReturnsOnCall(i int, result1 *resource.SpaceQuota, result2 error) {
	fake.singleMutex.Lock()
	defer fake.singleMutex.Unlock()
	fake.SingleStub = nil
