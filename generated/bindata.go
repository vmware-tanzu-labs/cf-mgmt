...
var _bindataFilesCfmgmtSh = []byte("")

func bindataFilesCfmgmtShBytes() ([]byte, error) {
	return bindataRead(
		_bindataFilesCfmgmtSh,
		"files/cf-mgmt.sh",
	)
}
...
func bindataFilesCfmgmtSh() (*asset, error) {
	bytes, err := bindataFilesCfmgmtShBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{
		name: "files/cf-mgmt.sh",
		size: 83,
		md5checksum: "",
		mode: os.FileMode(493),
		modTime: time.Unix(1626444917, 0),
	}
...
func bindataFilesCfmgmtYml() (*asset, error) {
	bytes, err := bindataFilesCfmgmtYmlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{
		name: "files/cf-mgmt.yml",
		size: 357,
		md5checksum: "",
...
func bindataFilesPipelineYml() (*asset, error) {
	bytes, err := bindataFilesPipelineYmlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{
		name: "files/pipeline.yml",
		size: 9312,
		md5checksum: "",
		mode: os.FileMode(420),
		modTime: time.Unix(1626444917, 0),
...
func bindataFilesVarstemplateYml() (*asset, error) {
	bytes, err := bindataFilesVarstemplateYmlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{
		name: "files/vars-template.yml",
		size: 798,
		md5checksum: "",
		mode: os.FileMode(420),
		modTime: time.Unix(1626444917, 0),
...
var _bindata = map[string]func() (*asset, error){
	"files/cf-mgmt.sh":        bindataFilesCfmgmtSh,
	"files/cf-mgmt.yml":       bindataFilesCfmgmtYml,
	"files/pipeline.yml":      bindataFilesPipelineYml,
	"files/vars-template.yml": bindataFilesVarstemplateYml,
}
...
var _bintree = &bintree{Func: nil, Children: map[string]*bintree{
	"files": {Func: nil, Children: map[string]*bintree{
		"cf-mgmt.sh": {Func: bindataFilesCfmgmtSh, Children: map[string]*bintree{}},
		"cf-mgmt.yml": {Func: bindataFilesCfmgmtYml, Children: map[string]*bintree{}},
		"pipeline.yml": {Func: bindataFilesPipelineYml, Children: map[string]*bintree{}},
		"vars-template.yml": {Func: bindataFilesVarstemplateYml, Children: map[string]*bintree{}},
	}},
}}
