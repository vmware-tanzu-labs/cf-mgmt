...
func pipelinePipelineYml() (*asset, error) {
	...
	info := bindataFileInfo{name: "pipeline/pipeline.yml", size: 2111, mode: os.FileMode(420), modTime: time.Unix(1466720266, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
