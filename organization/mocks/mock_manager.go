...
func (_m *MockManager) CreateOrgs() error {
	ret := _m.ctrl.Call(_m, "CreateOrgs")
	ret0, _ := ret[0].(error)
	return ret0
}

func (_mr *_MockManagerRecorder) CreateOrgs() *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "CreateOrgs")
}

func (_m *MockManager) CreatePrivateDomains() error {
	ret := _m.ctrl.Call(_m, "CreatePrivateDomains")
	ret0, _ := ret[0].(error)
	return ret0
}

func (_mr *_MockManagerRecorder) CreatePrivateDomains() *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "CreatePrivateDomains")
}

func (_m *MockManager) CreateQuotas() error {
	ret := _m.ctrl.Call(_m, "CreateQuotas")
	ret0, _ := ret[0].(error)
	return ret0
}

func (_mr *_MockManagerRecorder) CreateQuotas() *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "CreateQuotas")
}

func (_m *MockManager) DeleteOrgs(_param0 bool) error {
	ret := _m.ctrl.Call(_m, "DeleteOrgs", _param0)
	ret0, _ := ret[0].(error)
	return ret0
}

func (_mr *_MockManagerRecorder) DeleteOrgs(arg0 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "DeleteOrgs", arg0)
}
