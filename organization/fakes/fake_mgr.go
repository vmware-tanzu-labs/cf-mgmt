...
func (fake *FakeManager) FindOrg(arg1 string) (cfclient.Org, error) {
...
func (fake *FakeManager) FindOrgCalls(stub func(string) (cfclient.Org, error)) {
	fake.findOrgMutex.Lock()
...
func (fake *FakeManager) FindOrgReturns(result1 cfclient.Org, result2 error) {
	fake.findOrgMutex.Lock()
	defer fake.findOrgMutex.Unlock()
...
func (fake *FakeManager) FindOrgReturnsOnCall(i int, result1 cfclient.Org, result2 error) {
	fake.findOrgMutex.Lock()
	defer fake.findOrgMutex.Unlock()
	fake.FindOrgStub = nil
...
func (fake *FakeManager) FindOrgByGUID(arg1 string) (cfclient.Org, error) {
...
func (fake *FakeManager) FindOrgByGUIDCalls(stub func(string) (cfclient.Org, error)) {
	fake.findOrgByGUIDMutex.Lock()
...
func (fake *FakeManager) FindOrgByGUIDReturns(result1 cfclient.Org, result2 error) {
	fake.findOrgByGUIDMutex.Lock()
	defer fake.findOrgByGUIDMutex.Unlock()
...
func (fake *FakeManager) FindOrgByGUIDReturnsOnCall(i int, result1 cfclient.Org, result2 error) {
	fake.findOrgByGUIDMutex.Lock()
	defer fake.findOrgByGUIDMutex.Unlock()
	fake.FindOrgByGUIDStub = nil
...
func (fake *FakeManager) GetOrgByGUID(arg1 string) (cfclient.Org, error) {
...
func (fake *FakeManager) GetOrgByGUIDCalls(stub func(string) (cfclient.Org, error)) {
	fake.getOrgByGUIDMutex.Lock()
...
func (fake *FakeManager) GetOrgByGUIDReturns(result1 cfclient.Org, result2 error) {
	fake.getOrgByGUIDMutex.Lock()
	defer fake.getOrgByGUIDMutex.Unlock()
...
func (fake *FakeManager) GetOrgByGUIDReturnsOnCall(i int, result1 cfclient.Org, result2 error) {
	fake.getOrgByGUIDMutex.Lock()
	defer fake.getOrgByGUIDMutex.Unlock()
	fake.GetOrgByGUIDStub = nil
...
func (fake *FakeManager) GetOrgGUID(arg1 string) (string, error) {
...
func (fake *FakeManager) GetOrgGUIDCalls(stub func(string) (string, error)) {
	fake.getOrgGUIDMutex.Lock()
...
func (fake *FakeManager) GetOrgGUIDReturnsOnCall(i int, result1 string, result2 error) {
	fake.getOrgGUIDMutex.Lock()
	defer fake.getOrgGUIDMutex.Unlock()
	fake.GetOrgGUIDStub = nil
...
func (fake *FakeManager) ListOrgs() ([]cfclient.Org, error) {
...
func (fake *FakeManager) ListOrgsCalls(stub func() ([]cfclient.Org, error)) {
	fake.listOrgsMutex.Lock()
	defer fake.listOrgsMutex.Unlock()
	fake.ListOrgsStub = stub
}

func (fake *FakeManager) ListOrgsReturns(result1 []cfclient.Org, result2 error) {
	fake.listOrgsMutex.Lock()
	defer fake.listOrgsMutex.Unlock()
...
func (fake *FakeManager) ListOrgsReturnsOnCall(i int, result1 []cfclient.Org, result2 error) {
	fake.listOrgsMutex.Lock()
	defer fake.listOrgsMutex.Unlock()
	fake.ListOrgsStub = nil
