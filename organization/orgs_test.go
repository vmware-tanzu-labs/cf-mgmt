...
var _ = Describe("given OrgManager", func() {
	...
	Context("UpdateOrgUsers()", func() {
		...
		It("update org users where users are already in uaac", func() {
			...
			mockCloudController.EXPECT().AddUserToOrgRole("cwashburn@pivotal.io", "billing_managers", "testOrgGUID").Return(nil)
			mockCloudController.EXPECT().AddUserToOrgRole("cwashburn2@pivotal.io", "billing_managers", "testOrgGUID").Return(nil)
			...
			mockCloudController.EXPECT().AddUserToOrgRole("cwashburn@pivotal.io", "managers", "testOrgGUID").Return(nil)
			mockCloudController.EXPECT().AddUserToOrgRole("cwashburn2@pivotal.io", "managers", "testOrgGUID").Return(nil)
			...
			mockCloudController.EXPECT().AddUserToOrgRole("cwashburn@pivotal.io", "auditors", "testOrgGUID").Return(nil)
			mockCloudController.EXPECT().AddUserToOrgRole("cwashburn2@pivotal.io", "auditors", "testOrgGUID").Return(nil)
