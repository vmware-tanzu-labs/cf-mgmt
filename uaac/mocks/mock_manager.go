...
func (_m *MockManager) CreateLdapUser(_param0 string, _param1 string, _param2 string) error {
	ret := _m.ctrl.Call(_m, "CreateLdapUser", _param0, _param1, _param2)
	ret0, _ := ret[0].(error)
	return ret0
}

func (_mr *_MockManagerRecorder) CreateLdapUser(arg0, arg1, arg2 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "CreateLdapUser", arg0, arg1, arg2)
}
